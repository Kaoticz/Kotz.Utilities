...
public static class LinqExt
{
    ...
    public static IEnumerable<T> When<T>(this IEnumerable<T> collection, Predicate<IEnumerable<T>> predicate, Func<IEnumerable<T>, IEnumerable<T>> action, Func<IEnumerable<T>, IEnumerable<T>> elseAction)
